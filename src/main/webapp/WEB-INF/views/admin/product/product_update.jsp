...
<body class="sb-nav-fixed">
		...
		<!-- 메인보드 영역 -->
		<main>
		<form method="post" action="/admin/product_update" enctype="multipart/form-data">
		<input type="hidden" name="product_category_before" value="${product.productCategory}">
		<input type="hidden" name="product_code_before" value="${product.productCode}">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<div class="row">
										<div class="col-sm-3">
											<input id="product_code" name="product_code" class="form-control form-control-sm"  type="text" value="${product.productCode}">
										</div>
										<div class="col-sm-6">
							...
							<tr>
								...
								<td>
									<div class="row">
										<div class="col-sm-6">
											<input id="product_name" type="text" name="product_name" class="form-control form-control-sm" value="${product.productName}" >
										</div>
									</div>
								</td>
							</tr>
						...
						<tbody>
							<tr>
								...
								<td>
									<div class="row">
										<div class="col-sm-2">
											<input id="price" type="text" name="price" class="form-control form-control-sm" value="${product.price }">
										</div>
										<div class="col-sm-6">
							...
							<tr>
								...
								<td>
									...
									name="stock_quantity" value="${product.stock }">
										</div>
										<div class="col-sm-6">
