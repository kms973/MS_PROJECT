        	...
        	<nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
	            <div class="sb-sidenav-menu">
	                <div class="nav">
	                    ...
	                    <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
	                        <nav class="sb-sidenav-menu-nested nav">
	                            <a class="nav-link" href="admin/board/notice.jsp">공지사항</a>
	                            <a class="nav-link" href="admin/board/qna.jsp">FAQ 관리</a>
	                            <a class="nav-link" href="#!">1:1 문의 설정</a>
	                            <a class="nav-link" href="admin/board/review.jsp">리뷰 관리</a>
	                        </nav>
	                    </div>
	                    <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapseLayouts" aria-expanded="false" aria-controls="collapseLayouts">
	                    ...
	                    <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
	                        <nav class="sb-sidenav-menu-nested nav">
	                            <a class="nav-link" href="admin/product/product_list.jsp">전체 상품관리</a>
	                            <a class="nav-link" href="admin/product/product_new.jsp">상품 등록</a>
	                    ...
	                    <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
	                        <nav class="sb-sidenav-menu-nested nav">
	                            <a class="nav-link" href="admin/order/order_list.jsp">주문 내역</a>
	            ...
	            <main>
	                <div class="container-fluid px-4">
	                    ...
	                    <ol class="breadcrumb mb-4">
	                        <li class="breadcrumb-item active">전체 상품 관리</li>
	                    </ol>
	                </div>
	            </main>
	        </div>
