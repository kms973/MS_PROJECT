...
<section id="buypay" class="container wrap">
...
<div class="col-9 left ps-0">
	<table class="table mb-5" >
	  ...
	  <tbody>
	  	<c:forEach items="${listCart2}" var="listCart2" varStatus="loop">
	    <tr class="product${loop.index}" id="product${loop.index}">
	      <td class="col-6">
	   		<div class="product-img d-flex">
	   			<img src="/img/${listCart2.product_img }" class="img-fluid" width="30%" alt="제품 이미지">
	   			<div>
	   			<div class="ppname row mx-2 mt-5">${listCart2.product_name}</div>
	   			<div style="font-size:6px; color: red; padding:0; margin:10px;">&#45; 옵션명: <span class="poptions">${listCart2.options }</span></div>
	   			</div>
	   		</div>	   		
	      </td>
	      <td class="col-2">
	      	<div class="quantity-controls mt-5">
	      		<div class="pronum" id='result${loop.index}'>${listCart2.stock_quantity}</div>
	      	</div>
	      </td>
	      <td class="col-2"><div class="mt-5 gaaap">${listCart2.price}</div></td>
	      <td class="col-2">
	      	<div class="mt-5 mx-2">
	      		<div name="pp_price" id="pp_price${loop.index}" class="pp_price product-price" data-price="${listCart2.price}" data-stock-quantity="${listCart2.stock_quantity}">${listCart2.price * listCart2.stock_quantity}</div>
	      	</div>
	      	</td>
	    </tr>
	    </c:forEach>	    
